...
const EditPatient = () => {
    ...
    const {data,isLoading:getPatientLoading} = useGetPatientQuery({
        id : id,
        token
    })
    // console.log(data)
        ...
        >
          ...
          <Grid container spacing={2}>
                ...
                <Grid item xs={12} sm={4}>
                    ...
                    >
                        <MenuItem disabled value="" sx={{ fontSize: '0.9rem',fontWeight:'600' }}>
                            sexe
                        </MenuItem>
                        <MenuItem value="masculin" sx={{ fontSize: '0.9rem',fontWeight:'600' }}>
                            Masculin
                        </MenuItem>
                        <MenuItem value="féminin"sx={{ fontSize: '0.9rem',fontWeight:'600' }}>
                            Féminin
                        </MenuItem>
                    </Select>
                </Grid>
